...
public class ControlPanel extends Frame 
{
  ...
  Label resultValueLabel = new Label("0" , Label.LEFT) ;
  Label Seg1ValueLabel = new Label("0" , Label.LEFT) ;
  Label Seg2ValueLabel = new Label("0" , Label.LEFT) ;
  ...
  public void init( Kernel useKernel , String commands , String config ) 
  {
    ...
    resultValueLabel.reshape( 395,245+25,230,15 );
    add( resultValueLabel );

    Seg1ValueLabel.reshape( 395,265+25,230,15 );
    add( Seg1ValueLabel );

    Seg2ValueLabel.reshape( 395,285+25,230,15 );
    add( Seg2ValueLabel );
    ...
    add(highLabel);
    //---------Resultados--------------------------------------
    Label resultLabel = new Label("Result Page => " , Label.LEFT) ;
    resultLabel.reshape(285,245+25,110,15);
    add(resultLabel);

    Label segmento_1 = new Label("Segmento => ",Label.LEFT);
    segmento_1.reshape(285,265+25,110,15);
    add(segmento_1);

    Label segmento_2 = new Label("Segmento => ",Label.LEFT);
    segmento_2.reshape(285,285+25,110,15);
    add(segmento_2);    
    //---------------------------------------------------------
  ...
  public void paintPage( Page page ) 
  {
    ...
    resultValueLabel.setText(Long.toString( page.result , Kernel.addressradix ) );
    //----------------------
    Seg2ValueLabel.setText(Long.toString( page.seg1_v , Kernel.addressradix ) );
    Seg1ValueLabel.setText(Long.toString( page.seg2_v , Kernel.addressradix ) );
